...
<img src="mappingInheritance.PNG"  alt="Hibernate Java Persistence!" width="500"/>

<img src="whyInheritance.PNG"  alt="Hibernate Java Persistence!" width="500"/>

1. This is for great **re-use** of classes!

<img src="howToInheritanceInORMframeworks.PNG"  alt="Hibernate Java Persistence!" width="500">
...
<img src="warningWhenMapping.PNG"  alt="Hibernate Java Persistence!" width="500">
...
<img src="hibernateHasFourDifferentStrategies.PNG"  alt="Hibernate Java Persistence!" width="500">
...
<img src="userCase.PNG"  alt="Hibernate Java Persistence!" width="500">

1. We will use **inheritance** on these **subclasses** as an example!

<img src="exampleAsCode.PNG"  alt="Hibernate Java Persistence!" width="500">

- Let's proceed with the **Single table** strategy first!
    - Everything will be **mapped** into **one table**!

<img src="singleTable.PNG"  alt="Hibernate Java Persistence!" width="500">
...
<img src="singleTableDiegram.PNG"  alt="Hibernate Java Persistence!" width="500">
