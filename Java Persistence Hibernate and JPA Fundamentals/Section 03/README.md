...
<div align="center">
    <img src="hibernate.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="helloWorldWithHibernate.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="session.PNG"  alt="Hibernate Java Persistence!" width="300"/>
</div>

1. We are using **Session** object to `persist` Message POJO to `Message Table`.

<div align="center">
    <img src="configuringSession.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="mapping.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
3. `<session-factory></session-factory>` building **session-factory** is **resource intense** process, that why this is limited to **one instance per data source**!

<div align="center">
    <img src="hibernateUtil.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="mappingWithXML.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="insertingNewRow.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="namingOfMappingClasses.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="PersistingObject.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>

1. The state of the `Message` Object at this point.

<div align="center">
    <img src="PersistingObjectSecond.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="PersistingObjectThird.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="noticeTheSameDomain.PNG"  alt="Hibernate Java Persistence!" width="400"/>
</div>

1. **NOTICE** the same domain package for **Java object** and the `.xml` configuration.

<div align="center">
    <img src="nullBeforeSaveEnds.PNG"  alt="Hibernate Java Persistence!" width="600"/>
</div>

1. As you can see, the `Message` Java class, does not have `id` yet, before its `save` is called.

<div align="center">
    <img src="idAfterSave.PNG"  alt="Hibernate Java Persistence!" width="600"/>
</div>

1. As you can see, the `Message` Java class, have now the `id`.

<div align="center">
    <img src="DbBeforeCommit.PNG"  alt="Hibernate Java Persistence!" width="600"/>
</div>
...
<div align="center">
    <img src="DbAfterCommit.PNG"  alt="Hibernate Java Persistence!" width="600"/>
</div>
...
<div align="center">
    <img src="mappingExpectionForHibernate5.PNG"  alt="Hibernate Java Persistence!" width="400"/>
</div>

- After Hibernate 5, `GenerationType.AUTO` have been changed.

<p align="center">
    <img src="hibernateDifference.jpg"  alt="Hibernate Java Persistence!" width="300"/>
</p>
...
<div align="center">
    <img src="LabExerciseJPA.PNG"  alt="Hibernate Java Persistence!" width="600"/>
</div>
...
<p align="center">
    <img src="memeTheAnswer.jpg"  alt="Hibernate Java Persistence!" width="500" height="300"/>
</p>

<div align="center">
    <img src="labAnswer.PNG"  alt="Hibernate Java Persistence!" width="600"/>
</div>
...
<div align="center">
    <img src="labAnswer2.PNG"  alt="Hibernate Java Persistence!" width="600"/>
</div>
...
<div align="center">
    <img src="labAnswer3.PNG"  alt="Hibernate Java Persistence!" width="600"/>
</div>
...
<div align="center">
    <img src="loggingLevels.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
```
<div align="center">
    <img src="allKindOfLogs.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="loggingLab.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="exerciseLogging.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>

1. When you enable the **Session** logging, you can see much information about its internals.

<div align="center">
    <img src="doNotEnableTheseSettings.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="manipulatingObject.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>

- This is inside **database**, context.

<div align="center">
    <img src="whatIsTransaction.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="findingObject.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="updatingObject.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="updatingObjectCommit.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>

1. Only after `.commit()` is called, the **Message** object is deleted from database.

<div align="center">
    <img src="messageEntity.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="messageGet.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="deletingObject.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="managedByTheSessionObject.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>

1. At line `17` **Message** with id `2` is loaded from database. It will be in `Persistent State`.

<div align="center">
    <img src="delted.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
...
<div align="center">
    <img src="manipulatingLab.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>

1. Updating the **Message** field does not have any effect after the `.close()` have been called. 

<div align="center">
    <img src="manipulatingLabAfter.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>

1. If trying to call methods on **closed** session, it will throw **exception**.

<div align="center">
    <img src="session2.PNG"  alt="Hibernate Java Persistence!" width="500"/>
</div>
